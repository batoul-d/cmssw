...
#from RecoJets.JetProducers.ak5PFJets_cfi import ak5PFJets (Bat: We cannot find ak5PFJets so we will just clone it from ak4PFJets)
from RecoJets.JetProducers.ak4PFJets_cfi import ak4PFJets
ak5PFJets = ak4PFJets.clone(rParam = 0.5)
ak5PFJets.doAreaFastjet = True
ak3PFJets = ak5PFJets.clone(rParam = 0.3)
#from RecoJets.JetProducers.ak5GenJets_cfi import ak5GenJets (Bat: same as above)
