...
akPuSoftDrop4PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akPuSoftDrop4PFJets"),
...
akPuSoftDrop4PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPuSoftDrop4CaloJets'))

# akPuSoftDrop4PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak4HiSignalGenJets'))

akPuSoftDrop4PFbTagger = bTaggers(
    "akPuSoftDrop4PF",
    0.4)
...
akPuSoftDrop4PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPuSoftDrop4PFJetBtaggingIP = cms.Sequence(
    akPuSoftDrop4PFImpactParameterTagInfos *
...
akPuSoftDrop4PFJetBtaggingSV = cms.Sequence(
    akPuSoftDrop4PFImpactParameterTagInfos *
...
akPuSoftDrop4PFJetBtaggingNegSV = cms.Sequence(
    akPuSoftDrop4PFImpactParameterTagInfos *
...
akPuSoftDrop4PFJetBtaggingMu = cms.Sequence(
    akPuSoftDrop4PFSoftPFMuonsTagInfos *
    akPuSoftDrop4PFSoftPFMuonBJetTags +
...
akPuSoftDrop4PFJetBtagging = cms.Sequence(
    akPuSoftDrop4PFJetBtaggingIP
    * akPuSoftDrop4PFJetBtaggingSV
    * akPuSoftDrop4PFJetBtaggingNegSV
    # * akPuSoftDrop4PFJetBtaggingMu
    )

akPuSoftDrop4PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPuSoftDrop4PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPuSoftDrop4PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPuSoftDrop4PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPuSoftDrop4PFNjettiness:tau1',
    'akPuSoftDrop4PFNjettiness:tau2',
    'akPuSoftDrop4PFNjettiness:tau3']

akPuSoftDrop4PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDrop4PFpatJetsWithBtagging"),
...
akPuSoftDrop4PFJetSequence_data = cms.Sequence(
    akPuSoftDrop4PFcorr
    *
    # akPuSoftDrop4PFJetID
    # *
...
akPuSoftDrop4PFJetSequence_mb = cms.Sequence(
    akPuSoftDrop4PFJetSequence_mc)
akPuSoftDrop4PFJetSequence_jec = cms.Sequence(
    akPuSoftDrop4PFJetSequence_mc)

akPuSoftDrop4PFJetSequence = cms.Sequence(
    akPuSoftDrop4PFJetSequence_jec)
