...
akCsSoftDrop2PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCsSoftDrop2CaloJets'))

# akCsSoftDrop2PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak2HiSignalGenJets'))

akCsSoftDrop2PFbTagger = bTaggers(
    "akCsSoftDrop2PF",
    0.2)
...
akCsSoftDrop2PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDrop2PFJetBtaggingIP = cms.Sequence(
    akCsSoftDrop2PFImpactParameterTagInfos *
...
akCsSoftDrop2PFJetBtaggingSV = cms.Sequence(
    akCsSoftDrop2PFImpactParameterTagInfos *
...
akCsSoftDrop2PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDrop2PFImpactParameterTagInfos *
...
akCsSoftDrop2PFJetBtaggingMu = cms.Sequence(
    akCsSoftDrop2PFSoftPFMuonsTagInfos *
    akCsSoftDrop2PFSoftPFMuonBJetTags +
...
akCsSoftDrop2PFJetBtagging = cms.Sequence(
    akCsSoftDrop2PFJetBtaggingIP
    * akCsSoftDrop2PFJetBtaggingSV
    * akCsSoftDrop2PFJetBtaggingNegSV
    # * akCsSoftDrop2PFJetBtaggingMu
    )

akCsSoftDrop2PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCsSoftDrop2PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDrop2PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDrop2PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDrop2PFNjettiness:tau1',
    'akCsSoftDrop2PFNjettiness:tau2',
...
akCsSoftDrop2PFJetSequence_data = cms.Sequence(
    akCsSoftDrop2PFcorr
    *
    # akCsSoftDrop2PFJetID
    # *
...
akCsSoftDrop2PFJetSequence_mb = cms.Sequence(
    akCsSoftDrop2PFJetSequence_mc)
akCsSoftDrop2PFJetSequence_jec = cms.Sequence(
    akCsSoftDrop2PFJetSequence_mc)

akCsSoftDrop2PFJetSequence = cms.Sequence(
    akCsSoftDrop2PFJetSequence_data)
