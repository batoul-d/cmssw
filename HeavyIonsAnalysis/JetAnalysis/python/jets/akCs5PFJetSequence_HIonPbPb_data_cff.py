...
akCs5PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCs5PFJets"),
...
akCs5PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCs5CaloJets'))

# akCs5PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak5HiSignalGenJets'))

akCs5PFbTagger = bTaggers(
    "akCs5PF",
    0.5)
...
akCs5PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCs5PFJetBtaggingIP = cms.Sequence(
    akCs5PFImpactParameterTagInfos *
...
akCs5PFJetBtaggingSV = cms.Sequence(
    akCs5PFImpactParameterTagInfos *
...
akCs5PFJetBtaggingNegSV = cms.Sequence(
    akCs5PFImpactParameterTagInfos *
...
akCs5PFJetBtaggingMu = cms.Sequence(
    akCs5PFSoftPFMuonsTagInfos *
    akCs5PFSoftPFMuonBJetTags +
...
akCs5PFJetBtagging = cms.Sequence(
    akCs5PFJetBtaggingIP
    * akCs5PFJetBtaggingSV
    * akCs5PFJetBtaggingNegSV
    # * akCs5PFJetBtaggingMu
    )

akCs5PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCs5PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCs5PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCs5PFNjettiness:tau1',
    'akCs5PFNjettiness:tau2',
    'akCs5PFNjettiness:tau3']

akCs5PFJetAnalyzer = inclusiveJetAnalyzer.clone(
...
akCs5PFJetSequence_data = cms.Sequence(
    akCs5PFcorr
    *
    # akCs5PFJetID
    # *
...
akCs5PFJetSequence_mb = cms.Sequence(
    akCs5PFJetSequence_mc)
akCs5PFJetSequence_jec = cms.Sequence(
    akCs5PFJetSequence_mc)

akCs5PFJetSequence = cms.Sequence(
    akCs5PFJetSequence_data)
