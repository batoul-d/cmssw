...
akPuSoftDropZ05B153PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akPuSoftDropZ05B153PFJets"),
...
akPuSoftDropZ05B153PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPuSoftDropZ05B153CaloJets'))

# akPuSoftDropZ05B153PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiSignalGenJets'))

akPuSoftDropZ05B153PFbTagger = bTaggers(
    "akPuSoftDropZ05B153PF",
    0.3)
...
akPuSoftDropZ05B153PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPuSoftDropZ05B153PFJetBtaggingIP = cms.Sequence(
    akPuSoftDropZ05B153PFImpactParameterTagInfos *
...
akPuSoftDropZ05B153PFJetBtaggingSV = cms.Sequence(
    akPuSoftDropZ05B153PFImpactParameterTagInfos *
...
akPuSoftDropZ05B153PFJetBtaggingNegSV = cms.Sequence(
    akPuSoftDropZ05B153PFImpactParameterTagInfos *
...
akPuSoftDropZ05B153PFJetBtaggingMu = cms.Sequence(
    akPuSoftDropZ05B153PFSoftPFMuonsTagInfos *
    akPuSoftDropZ05B153PFSoftPFMuonBJetTags +
...
akPuSoftDropZ05B153PFJetBtagging = cms.Sequence(
    akPuSoftDropZ05B153PFJetBtaggingIP
    * akPuSoftDropZ05B153PFJetBtaggingSV
    * akPuSoftDropZ05B153PFJetBtaggingNegSV
    # * akPuSoftDropZ05B153PFJetBtaggingMu
    )

akPuSoftDropZ05B153PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPuSoftDropZ05B153PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPuSoftDropZ05B153PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPuSoftDropZ05B153PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPuSoftDropZ05B153PFNjettiness:tau1',
    'akPuSoftDropZ05B153PFNjettiness:tau2',
    'akPuSoftDropZ05B153PFNjettiness:tau3']

akPuSoftDropZ05B153PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDropZ05B153PFpatJetsWithBtagging"),
...
akPuSoftDropZ05B153PFJetSequence_data = cms.Sequence(
    akPuSoftDropZ05B153PFcorr
    *
    # akPuSoftDropZ05B153PFJetID
    # *
...
akPuSoftDropZ05B153PFJetSequence_mb = cms.Sequence(
    akPuSoftDropZ05B153PFJetSequence_mc)
akPuSoftDropZ05B153PFJetSequence_jec = cms.Sequence(
    akPuSoftDropZ05B153PFJetSequence_mc)

akPuSoftDropZ05B153PFJetSequence = cms.Sequence(
    akPuSoftDropZ05B153PFJetSequence_data)
