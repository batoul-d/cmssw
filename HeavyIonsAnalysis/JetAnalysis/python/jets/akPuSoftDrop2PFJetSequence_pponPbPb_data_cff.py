...
akPuSoftDrop2PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPuSoftDrop2CaloJets'))

# akPuSoftDrop2PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak2HiSignalGenJets'))

akPuSoftDrop2PFbTagger = bTaggers(
    "akPuSoftDrop2PF",
    0.2)
...
akPuSoftDrop2PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPuSoftDrop2PFJetBtaggingIP = cms.Sequence(
    akPuSoftDrop2PFImpactParameterTagInfos *
...
akPuSoftDrop2PFJetBtaggingSV = cms.Sequence(
    akPuSoftDrop2PFImpactParameterTagInfos *
...
akPuSoftDrop2PFJetBtaggingNegSV = cms.Sequence(
    akPuSoftDrop2PFImpactParameterTagInfos *
...
akPuSoftDrop2PFJetBtaggingMu = cms.Sequence(
    akPuSoftDrop2PFSoftPFMuonsTagInfos *
    akPuSoftDrop2PFSoftPFMuonBJetTags +
...
akPuSoftDrop2PFJetBtagging = cms.Sequence(
    akPuSoftDrop2PFJetBtaggingIP
    * akPuSoftDrop2PFJetBtaggingSV
    * akPuSoftDrop2PFJetBtaggingNegSV
    # * akPuSoftDrop2PFJetBtaggingMu
    )

akPuSoftDrop2PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPuSoftDrop2PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPuSoftDrop2PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPuSoftDrop2PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPuSoftDrop2PFNjettiness:tau1',
    'akPuSoftDrop2PFNjettiness:tau2',
    'akPuSoftDrop2PFNjettiness:tau3']

akPuSoftDrop2PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDrop2PFpatJetsWithBtagging"),
...
akPuSoftDrop2PFJetSequence_data = cms.Sequence(
    akPuSoftDrop2PFcorr
    *
    # akPuSoftDrop2PFJetID
    # *
...
akPuSoftDrop2PFJetSequence_mb = cms.Sequence(
    akPuSoftDrop2PFJetSequence_mc)
akPuSoftDrop2PFJetSequence_jec = cms.Sequence(
    akPuSoftDrop2PFJetSequence_mc)

akPuSoftDrop2PFJetSequence = cms.Sequence(
    akPuSoftDrop2PFJetSequence_data)
