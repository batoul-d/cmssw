...
akPu6PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPu6CaloJets'))

# akPu6PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak6HiSignalGenJets'))

akPu6PFbTagger = bTaggers(
    "akPu6PF",
    0.6)
...
akPu6PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPu6PFJetBtaggingIP = cms.Sequence(
    akPu6PFImpactParameterTagInfos *
...
akPu6PFJetBtaggingSV = cms.Sequence(
    akPu6PFImpactParameterTagInfos *
...
akPu6PFJetBtaggingNegSV = cms.Sequence(
    akPu6PFImpactParameterTagInfos *
...
akPu6PFJetBtaggingMu = cms.Sequence(
    akPu6PFSoftPFMuonsTagInfos *
    akPu6PFSoftPFMuonBJetTags +
...
akPu6PFJetBtagging = cms.Sequence(
    akPu6PFJetBtaggingIP
    * akPu6PFJetBtaggingSV
    * akPu6PFJetBtaggingNegSV
    # * akPu6PFJetBtaggingMu
    )

akPu6PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPu6PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPu6PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPu6PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPu6PFNjettiness:tau1',
    'akPu6PFNjettiness:tau2',
    'akPu6PFNjettiness:tau3']

akPu6PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPu6PFpatJetsWithBtagging"),
...
akPu6PFJetSequence_data = cms.Sequence(
    akPu6PFcorr
    *
    # akPu6PFJetID
    # *
...
akPu6PFJetSequence_mb = cms.Sequence(
    akPu6PFJetSequence_mc)
akPu6PFJetSequence_jec = cms.Sequence(
    akPu6PFJetSequence_mc)

akPu6PFJetSequence = cms.Sequence(
    akPu6PFJetSequence_data)
