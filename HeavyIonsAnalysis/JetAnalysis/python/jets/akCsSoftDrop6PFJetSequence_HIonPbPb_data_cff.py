...
# akCsSoftDrop6PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak6HiSignalGenJets'))

akCsSoftDrop6PFbTagger = bTaggers(
    "akCsSoftDrop6PF",
    0.6)
...
akCsSoftDrop6PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDrop6PFJetBtaggingIP = cms.Sequence(
    akCsSoftDrop6PFImpactParameterTagInfos *
...
akCsSoftDrop6PFJetBtaggingSV = cms.Sequence(
    akCsSoftDrop6PFImpactParameterTagInfos *
...
akCsSoftDrop6PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDrop6PFImpactParameterTagInfos *
...
akCsSoftDrop6PFJetBtaggingMu = cms.Sequence(
    akCsSoftDrop6PFSoftPFMuonsTagInfos *
    akCsSoftDrop6PFSoftPFMuonBJetTags +
...
akCsSoftDrop6PFJetBtagging = cms.Sequence(
    akCsSoftDrop6PFJetBtaggingIP
    * akCsSoftDrop6PFJetBtaggingSV
    * akCsSoftDrop6PFJetBtaggingNegSV
    # * akCsSoftDrop6PFJetBtaggingMu
    )

akCsSoftDrop6PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCsSoftDrop6PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDrop6PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDrop6PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDrop6PFNjettiness:tau1',
    'akCsSoftDrop6PFNjettiness:tau2',
    'akCsSoftDrop6PFNjettiness:tau3']

akCsSoftDrop6PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akCsSoftDrop6PFpatJetsWithBtagging"),
...
akCsSoftDrop6PFJetSequence_data = cms.Sequence(
    akCsSoftDrop6PFcorr
    *
    # akCsSoftDrop6PFJetID
    # *
...
akCsSoftDrop6PFJetSequence_mb = cms.Sequence(
    akCsSoftDrop6PFJetSequence_mc)
akCsSoftDrop6PFJetSequence_jec = cms.Sequence(
    akCsSoftDrop6PFJetSequence_mc)

akCsSoftDrop6PFJetSequence = cms.Sequence(
    akCsSoftDrop6PFJetSequence_data)
