...
akCs3PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCs3PFJets"),
...
akCs3PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCs3CaloJets'))

# akCs3PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiSignalGenJets'))

akCs3PFbTagger = bTaggers(
    "akCs3PF",
    0.3)
...
akCs3PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCs3PFJetBtaggingIP = cms.Sequence(
    akCs3PFImpactParameterTagInfos *
...
akCs3PFJetBtaggingSV = cms.Sequence(
    akCs3PFImpactParameterTagInfos *
...
akCs3PFJetBtaggingNegSV = cms.Sequence(
    akCs3PFImpactParameterTagInfos *
...
akCs3PFJetBtaggingMu = cms.Sequence(
    akCs3PFSoftPFMuonsTagInfos *
    akCs3PFSoftPFMuonBJetTags +
...
akCs3PFJetBtagging = cms.Sequence(
    akCs3PFJetBtaggingIP
    * akCs3PFJetBtaggingSV
    * akCs3PFJetBtaggingNegSV
    # * akCs3PFJetBtaggingMu
    )

akCs3PFpatJetsWithBtagging = patJets.clone(
...
akCs3PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCs3PFNjettiness:tau1',
    'akCs3PFNjettiness:tau2',
...
akCs3PFJetSequence_mb = cms.Sequence(
    akCs3PFJetSequence_mc)
akCs3PFJetSequence_jec = cms.Sequence(
    akCs3PFJetSequence_mc)

akCs3PFJetSequence = cms.Sequence(
    akCs3PFJetSequence_data)
