...
akSoftDropZ05B152PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akSoftDropZ05B152PFJets"),
...
akSoftDropZ05B152PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akSoftDropZ05B152CaloJets'))

# akSoftDropZ05B152PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak2HiSignalGenJets'))

akSoftDropZ05B152PFbTagger = bTaggers(
    "akSoftDropZ05B152PF",
    0.2)
...
akSoftDropZ05B152PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akSoftDropZ05B152PFJetBtaggingIP = cms.Sequence(
    akSoftDropZ05B152PFImpactParameterTagInfos *
...
akSoftDropZ05B152PFJetBtaggingSV = cms.Sequence(
    akSoftDropZ05B152PFImpactParameterTagInfos *
...
akSoftDropZ05B152PFJetBtaggingNegSV = cms.Sequence(
    akSoftDropZ05B152PFImpactParameterTagInfos *
...
akSoftDropZ05B152PFJetBtaggingMu = cms.Sequence(
    akSoftDropZ05B152PFSoftPFMuonsTagInfos *
    akSoftDropZ05B152PFSoftPFMuonBJetTags +
...
akSoftDropZ05B152PFJetBtagging = cms.Sequence(
    akSoftDropZ05B152PFJetBtaggingIP
    * akSoftDropZ05B152PFJetBtaggingSV
    * akSoftDropZ05B152PFJetBtaggingNegSV
    # * akSoftDropZ05B152PFJetBtaggingMu
    )

akSoftDropZ05B152PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akSoftDropZ05B152PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akSoftDropZ05B152PFSimpleSecondaryVertexHighEffBJetTags"),
...
akSoftDropZ05B152PFpatJetsWithBtagging.userData.userFloats.src += [
    'akSoftDropZ05B152PFNjettiness:tau1',
    'akSoftDropZ05B152PFNjettiness:tau2',
    'akSoftDropZ05B152PFNjettiness:tau3']

akSoftDropZ05B152PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akSoftDropZ05B152PFpatJetsWithBtagging"),
...
akSoftDropZ05B152PFJetSequence_data = cms.Sequence(
    akSoftDropZ05B152PFcorr
    *
    # akSoftDropZ05B152PFJetID
    # *
...
akSoftDropZ05B152PFJetSequence_mb = cms.Sequence(
    akSoftDropZ05B152PFJetSequence_mc)
akSoftDropZ05B152PFJetSequence_jec = cms.Sequence(
    akSoftDropZ05B152PFJetSequence_mc)

akSoftDropZ05B152PFJetSequence = cms.Sequence(
    akSoftDropZ05B152PFJetSequence_data)
