...
akCsSoftDrop4PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCsSoftDrop4PFJets"),
...
akCsSoftDrop4PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCsSoftDrop4CaloJets'))

# akCsSoftDrop4PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak4HiSignalGenJets'))

akCsSoftDrop4PFbTagger = bTaggers(
    "akCsSoftDrop4PF",
    0.4)
...
akCsSoftDrop4PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDrop4PFJetBtaggingIP = cms.Sequence(
...
akCsSoftDrop4PFJetBtaggingSV = cms.Sequence(
    akCsSoftDrop4PFImpactParameterTagInfos *
...
akCsSoftDrop4PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDrop4PFImpactParameterTagInfos *
...
akCsSoftDrop4PFJetBtaggingMu = cms.Sequence(
    akCsSoftDrop4PFSoftPFMuonsTagInfos *
    akCsSoftDrop4PFSoftPFMuonBJetTags +
...
akCsSoftDrop4PFJetBtagging = cms.Sequence(
    akCsSoftDrop4PFJetBtaggingIP
    * akCsSoftDrop4PFJetBtaggingSV
    * akCsSoftDrop4PFJetBtaggingNegSV
    # * akCsSoftDrop4PFJetBtaggingMu
    )

akCsSoftDrop4PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDrop4PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDrop4PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDrop4PFNjettiness:tau1',
    'akCsSoftDrop4PFNjettiness:tau2',
    'akCsSoftDrop4PFNjettiness:tau3']

akCsSoftDrop4PFJetAnalyzer = inclusiveJetAnalyzer.clone(
...
akCsSoftDrop4PFJetSequence_data = cms.Sequence(
    akCsSoftDrop4PFcorr
    *
    # akCsSoftDrop4PFJetID
    # *
...
akCsSoftDrop4PFJetSequence_mb = cms.Sequence(
    akCsSoftDrop4PFJetSequence_mc)
akCsSoftDrop4PFJetSequence_jec = cms.Sequence(
    akCsSoftDrop4PFJetSequence_mc)

akCsSoftDrop4PFJetSequence = cms.Sequence(
    akCsSoftDrop4PFJetSequence_data)
