...
akCsSoftDropZ05B153PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCsSoftDropZ05B153PFJets"),
...
akCsSoftDropZ05B153PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCsSoftDropZ05B153CaloJets'))

# akCsSoftDropZ05B153PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiSignalGenJets'))

akCsSoftDropZ05B153PFbTagger = bTaggers(
    "akCsSoftDropZ05B153PF",
    0.3)
...
akCsSoftDropZ05B153PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDropZ05B153PFJetBtaggingIP = cms.Sequence(
    akCsSoftDropZ05B153PFImpactParameterTagInfos *
...
akCsSoftDropZ05B153PFJetBtaggingSV = cms.Sequence(
    akCsSoftDropZ05B153PFImpactParameterTagInfos *
...
akCsSoftDropZ05B153PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDropZ05B153PFImpactParameterTagInfos *
...
akCsSoftDropZ05B153PFJetBtaggingMu = cms.Sequence(
    akCsSoftDropZ05B153PFSoftPFMuonsTagInfos *
    akCsSoftDropZ05B153PFSoftPFMuonBJetTags +
...
akCsSoftDropZ05B153PFJetBtagging = cms.Sequence(
    akCsSoftDropZ05B153PFJetBtaggingIP
    * akCsSoftDropZ05B153PFJetBtaggingSV
    * akCsSoftDropZ05B153PFJetBtaggingNegSV
    # * akCsSoftDropZ05B153PFJetBtaggingMu
    )

akCsSoftDropZ05B153PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCsSoftDropZ05B153PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDropZ05B153PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDropZ05B153PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDropZ05B153PFNjettiness:tau1',
    'akCsSoftDropZ05B153PFNjettiness:tau2',
    'akCsSoftDropZ05B153PFNjettiness:tau3']

akCsSoftDropZ05B153PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akCsSoftDropZ05B153PFpatJetsWithBtagging"),
...
akCsSoftDropZ05B153PFJetSequence_data = cms.Sequence(
    akCsSoftDropZ05B153PFcorr
    *
    # akCsSoftDropZ05B153PFJetID
    # *
...
akCsSoftDropZ05B153PFJetSequence_mb = cms.Sequence(
    akCsSoftDropZ05B153PFJetSequence_mc)
akCsSoftDropZ05B153PFJetSequence_jec = cms.Sequence(
    akCsSoftDropZ05B153PFJetSequence_mc)

akCsSoftDropZ05B153PFJetSequence = cms.Sequence(
    akCsSoftDropZ05B153PFJetSequence_data)
