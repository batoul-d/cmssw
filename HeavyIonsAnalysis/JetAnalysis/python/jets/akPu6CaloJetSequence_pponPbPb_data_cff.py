...
akPu6CaloJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPu6CaloJets'))

# akPu6Caloclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak6HiSignalGenJets'))

akPu6CalobTagger = bTaggers(
    "akPu6Calo",
    0.6)
...
akPu6CaloPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPu6CaloJetBtaggingIP = cms.Sequence(
    akPu6CaloImpactParameterTagInfos *
...
akPu6CaloJetBtaggingSV = cms.Sequence(
    akPu6CaloImpactParameterTagInfos *
...
akPu6CaloJetBtaggingNegSV = cms.Sequence(
    akPu6CaloImpactParameterTagInfos *
...
akPu6CaloJetBtaggingMu = cms.Sequence(
    akPu6CaloSoftPFMuonsTagInfos *
    akPu6CaloSoftPFMuonBJetTags +
...
akPu6CaloJetBtagging = cms.Sequence(
    akPu6CaloJetBtaggingIP
    * akPu6CaloJetBtaggingSV
    * akPu6CaloJetBtaggingNegSV
    # * akPu6CaloJetBtaggingMu
    )

akPu6CalopatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPu6CaloJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPu6CaloSimpleSecondaryVertexHighEffBJetTags"),
...
akPu6CalopatJetsWithBtagging.userData.userFloats.src += [
    'akPu6CaloNjettiness:tau1',
    'akPu6CaloNjettiness:tau2',
    'akPu6CaloNjettiness:tau3']

akPu6CaloJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPu6CalopatJetsWithBtagging"),
...
akPu6CaloJetSequence_data = cms.Sequence(
    akPu6Calocorr
    *
    # akPu6CaloJetID
    # *
...
akPu6CaloJetSequence_mb = cms.Sequence(
    akPu6CaloJetSequence_mc)
akPu6CaloJetSequence_jec = cms.Sequence(
    akPu6CaloJetSequence_mc)

akPu6CaloJetSequence = cms.Sequence(
    akPu6CaloJetSequence_data)
