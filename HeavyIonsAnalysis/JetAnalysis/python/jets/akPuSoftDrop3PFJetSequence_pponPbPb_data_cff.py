...
# akPuSoftDrop3PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiSignalGenJets'))

akPuSoftDrop3PFbTagger = bTaggers(
    "akPuSoftDrop3PF",
    0.3)
...
akPuSoftDrop3PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPuSoftDrop3PFJetBtaggingIP = cms.Sequence(
    akPuSoftDrop3PFImpactParameterTagInfos *
...
akPuSoftDrop3PFJetBtaggingSV = cms.Sequence(
    akPuSoftDrop3PFImpactParameterTagInfos *
...
akPuSoftDrop3PFJetBtaggingNegSV = cms.Sequence(
    akPuSoftDrop3PFImpactParameterTagInfos *
...
akPuSoftDrop3PFJetBtaggingMu = cms.Sequence(
    akPuSoftDrop3PFSoftPFMuonsTagInfos *
    akPuSoftDrop3PFSoftPFMuonBJetTags +
...
akPuSoftDrop3PFJetBtagging = cms.Sequence(
    akPuSoftDrop3PFJetBtaggingIP
    * akPuSoftDrop3PFJetBtaggingSV
    * akPuSoftDrop3PFJetBtaggingNegSV
    # * akPuSoftDrop3PFJetBtaggingMu
    )

akPuSoftDrop3PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPuSoftDrop3PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPuSoftDrop3PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPuSoftDrop3PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPuSoftDrop3PFNjettiness:tau1',
    'akPuSoftDrop3PFNjettiness:tau2',
    'akPuSoftDrop3PFNjettiness:tau3']

akPuSoftDrop3PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDrop3PFpatJetsWithBtagging"),
...
akPuSoftDrop3PFJetSequence_data = cms.Sequence(
    akPuSoftDrop3PFcorr
    *
    # akPuSoftDrop3PFJetID
    # *
...
akPuSoftDrop3PFJetSequence_mb = cms.Sequence(
    akPuSoftDrop3PFJetSequence_mc)
akPuSoftDrop3PFJetSequence_jec = cms.Sequence(
    akPuSoftDrop3PFJetSequence_mc)

akPuSoftDrop3PFJetSequence = cms.Sequence(
    akPuSoftDrop3PFJetSequence_data)
