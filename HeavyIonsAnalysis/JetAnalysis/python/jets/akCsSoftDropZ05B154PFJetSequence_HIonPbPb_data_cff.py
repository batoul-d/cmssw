...
akCsSoftDropZ05B154PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCsSoftDropZ05B154PFJets"),
...
akCsSoftDropZ05B154PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCsSoftDropZ05B154CaloJets'))

# akCsSoftDropZ05B154PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak4HiSignalGenJets'))

akCsSoftDropZ05B154PFbTagger = bTaggers(
    "akCsSoftDropZ05B154PF",
    0.4)
...
akCsSoftDropZ05B154PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDropZ05B154PFJetBtaggingIP = cms.Sequence(
    akCsSoftDropZ05B154PFImpactParameterTagInfos *
...
akCsSoftDropZ05B154PFJetBtaggingSV = cms.Sequence(
    akCsSoftDropZ05B154PFImpactParameterTagInfos *
...
akCsSoftDropZ05B154PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDropZ05B154PFImpactParameterTagInfos *
...
akCsSoftDropZ05B154PFJetBtaggingMu = cms.Sequence(
    akCsSoftDropZ05B154PFSoftPFMuonsTagInfos *
    akCsSoftDropZ05B154PFSoftPFMuonBJetTags +
...
akCsSoftDropZ05B154PFJetBtagging = cms.Sequence(
    akCsSoftDropZ05B154PFJetBtaggingIP
    * akCsSoftDropZ05B154PFJetBtaggingSV
    * akCsSoftDropZ05B154PFJetBtaggingNegSV
    # * akCsSoftDropZ05B154PFJetBtaggingMu
    )

akCsSoftDropZ05B154PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDropZ05B154PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDropZ05B154PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDropZ05B154PFNjettiness:tau1',
    'akCsSoftDropZ05B154PFNjettiness:tau2',
    'akCsSoftDropZ05B154PFNjettiness:tau3']

akCsSoftDropZ05B154PFJetAnalyzer = inclusiveJetAnalyzer.clone(
...
akCsSoftDropZ05B154PFJetSequence_data = cms.Sequence(
    akCsSoftDropZ05B154PFcorr
    *
    # akCsSoftDropZ05B154PFJetID
    # *
...
akCsSoftDropZ05B154PFJetSequence_mb = cms.Sequence(
    akCsSoftDropZ05B154PFJetSequence_mc)
akCsSoftDropZ05B154PFJetSequence_jec = cms.Sequence(
    akCsSoftDropZ05B154PFJetSequence_mc)

akCsSoftDropZ05B154PFJetSequence = cms.Sequence(
    akCsSoftDropZ05B154PFJetSequence_data)
