...
akCs1PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCs1PFJets"),
...
akCs1PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCs1CaloJets'))

# akCs1PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak1HiSignalGenJets'))

akCs1PFbTagger = bTaggers(
    "akCs1PF",
    0.1)
...
akCs1PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCs1PFJetBtaggingIP = cms.Sequence(
    akCs1PFImpactParameterTagInfos *
...
akCs1PFJetBtaggingSV = cms.Sequence(
    akCs1PFImpactParameterTagInfos *
...
akCs1PFJetBtaggingNegSV = cms.Sequence(
    akCs1PFImpactParameterTagInfos *
...
akCs1PFJetBtaggingMu = cms.Sequence(
    akCs1PFSoftPFMuonsTagInfos *
    akCs1PFSoftPFMuonBJetTags +
...
akCs1PFJetBtagging = cms.Sequence(
    akCs1PFJetBtaggingIP
    * akCs1PFJetBtaggingSV
    * akCs1PFJetBtaggingNegSV
    # * akCs1PFJetBtaggingMu
    )

akCs1PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCs1PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCs1PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCs1PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCs1PFNjettiness:tau1',
    'akCs1PFNjettiness:tau2',
    'akCs1PFNjettiness:tau3']

akCs1PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akCs1PFpatJetsWithBtagging"),
...
akCs1PFJetSequence_data = cms.Sequence(
    akCs1PFcorr
    *
    # akCs1PFJetID
    # *
...
akCs1PFJetSequence_mb = cms.Sequence(
    akCs1PFJetSequence_mc)
akCs1PFJetSequence_jec = cms.Sequence(
    akCs1PFJetSequence_mc)

akCs1PFJetSequence = cms.Sequence(
    akCs1PFJetSequence_data)
