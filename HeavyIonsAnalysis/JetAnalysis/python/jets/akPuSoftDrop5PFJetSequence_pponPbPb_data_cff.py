...
akPuSoftDrop5PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akPuSoftDrop5PFJets"),
...
akPuSoftDrop5PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPuSoftDrop5CaloJets'))

# akPuSoftDrop5PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak5HiSignalGenJets'))

akPuSoftDrop5PFbTagger = bTaggers(
    "akPuSoftDrop5PF",
    0.5)
...
akPuSoftDrop5PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPuSoftDrop5PFJetBtaggingIP = cms.Sequence(
    akPuSoftDrop5PFImpactParameterTagInfos *
...
akPuSoftDrop5PFJetBtaggingSV = cms.Sequence(
    akPuSoftDrop5PFImpactParameterTagInfos *
...
akPuSoftDrop5PFJetBtaggingNegSV = cms.Sequence(
    akPuSoftDrop5PFImpactParameterTagInfos *
...
akPuSoftDrop5PFJetBtaggingMu = cms.Sequence(
    akPuSoftDrop5PFSoftPFMuonsTagInfos *
    akPuSoftDrop5PFSoftPFMuonBJetTags +
...
akPuSoftDrop5PFJetBtagging = cms.Sequence(
    akPuSoftDrop5PFJetBtaggingIP
    * akPuSoftDrop5PFJetBtaggingSV
    * akPuSoftDrop5PFJetBtaggingNegSV
    # * akPuSoftDrop5PFJetBtaggingMu
    )

akPuSoftDrop5PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPuSoftDrop5PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPuSoftDrop5PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPuSoftDrop5PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPuSoftDrop5PFNjettiness:tau1',
    'akPuSoftDrop5PFNjettiness:tau2',
    'akPuSoftDrop5PFNjettiness:tau3']

akPuSoftDrop5PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akPuSoftDrop5PFpatJetsWithBtagging"),
...
akPuSoftDrop5PFJetSequence_data = cms.Sequence(
    akPuSoftDrop5PFcorr
    *
    # akPuSoftDrop5PFJetID
    # *
...
akPuSoftDrop5PFJetSequence_mb = cms.Sequence(
    akPuSoftDrop5PFJetSequence_mc)
akPuSoftDrop5PFJetSequence_jec = cms.Sequence(
    akPuSoftDrop5PFJetSequence_mc)

akPuSoftDrop5PFJetSequence = cms.Sequence(
    akPuSoftDrop5PFJetSequence_data)
