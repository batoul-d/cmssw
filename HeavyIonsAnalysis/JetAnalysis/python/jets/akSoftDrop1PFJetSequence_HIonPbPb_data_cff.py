...
akSoftDrop1PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akSoftDrop1PFJets"),
...
akSoftDrop1PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akSoftDrop1CaloJets'))

# akSoftDrop1PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak1HiSignalGenJets'))

akSoftDrop1PFbTagger = bTaggers(
    "akSoftDrop1PF",
    0.1)
...
akSoftDrop1PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akSoftDrop1PFJetBtaggingIP = cms.Sequence(
    akSoftDrop1PFImpactParameterTagInfos *
...
akSoftDrop1PFJetBtaggingSV = cms.Sequence(
    akSoftDrop1PFImpactParameterTagInfos *
...
akSoftDrop1PFJetBtaggingNegSV = cms.Sequence(
    akSoftDrop1PFImpactParameterTagInfos *
...
akSoftDrop1PFJetBtaggingMu = cms.Sequence(
    akSoftDrop1PFSoftPFMuonsTagInfos *
    akSoftDrop1PFSoftPFMuonBJetTags +
...
akSoftDrop1PFJetBtagging = cms.Sequence(
    akSoftDrop1PFJetBtaggingIP
    * akSoftDrop1PFJetBtaggingSV
    * akSoftDrop1PFJetBtaggingNegSV
    # * akSoftDrop1PFJetBtaggingMu
    )

akSoftDrop1PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akSoftDrop1PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akSoftDrop1PFSimpleSecondaryVertexHighEffBJetTags"),
...
akSoftDrop1PFpatJetsWithBtagging.userData.userFloats.src += [
    'akSoftDrop1PFNjettiness:tau1',
    'akSoftDrop1PFNjettiness:tau2',
    'akSoftDrop1PFNjettiness:tau3']

akSoftDrop1PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akSoftDrop1PFpatJetsWithBtagging"),
...
akSoftDrop1PFJetSequence_data = cms.Sequence(
    akSoftDrop1PFcorr
    *
    # akSoftDrop1PFJetID
    # *
...
akSoftDrop1PFJetSequence_mb = cms.Sequence(
    akSoftDrop1PFJetSequence_mc)
akSoftDrop1PFJetSequence_jec = cms.Sequence(
    akSoftDrop1PFJetSequence_mc)

akSoftDrop1PFJetSequence = cms.Sequence(
    akSoftDrop1PFJetSequence_data)
