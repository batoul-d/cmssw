...
akCsSoftDrop1PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCsSoftDrop1PFJets"),
...
akCsSoftDrop1PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCsSoftDrop1CaloJets'))

# akCsSoftDrop1PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak1HiSignalGenJets'))

akCsSoftDrop1PFbTagger = bTaggers(
    "akCsSoftDrop1PF",
    0.1)
...
akCsSoftDrop1PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDrop1PFJetBtaggingIP = cms.Sequence(
    akCsSoftDrop1PFImpactParameterTagInfos *
...
akCsSoftDrop1PFJetBtaggingSV = cms.Sequence(
    akCsSoftDrop1PFImpactParameterTagInfos *
...
akCsSoftDrop1PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDrop1PFImpactParameterTagInfos *
...
akCsSoftDrop1PFJetBtaggingMu = cms.Sequence(
    akCsSoftDrop1PFSoftPFMuonsTagInfos *
    akCsSoftDrop1PFSoftPFMuonBJetTags +
...
akCsSoftDrop1PFJetBtagging = cms.Sequence(
    akCsSoftDrop1PFJetBtaggingIP
    * akCsSoftDrop1PFJetBtaggingSV
    * akCsSoftDrop1PFJetBtaggingNegSV
    # * akCsSoftDrop1PFJetBtaggingMu
    )

akCsSoftDrop1PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCsSoftDrop1PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDrop1PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDrop1PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDrop1PFNjettiness:tau1',
    'akCsSoftDrop1PFNjettiness:tau2',
    'akCsSoftDrop1PFNjettiness:tau3']

akCsSoftDrop1PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akCsSoftDrop1PFpatJetsWithBtagging"),
...
akCsSoftDrop1PFJetSequence_data = cms.Sequence(
    akCsSoftDrop1PFcorr
    *
    # akCsSoftDrop1PFJetID
    # *
...
akCsSoftDrop1PFJetSequence_mb = cms.Sequence(
    akCsSoftDrop1PFJetSequence_mc)
akCsSoftDrop1PFJetSequence_jec = cms.Sequence(
    akCsSoftDrop1PFJetSequence_mc)

akCsSoftDrop1PFJetSequence = cms.Sequence(
    akCsSoftDrop1PFJetSequence_data)
