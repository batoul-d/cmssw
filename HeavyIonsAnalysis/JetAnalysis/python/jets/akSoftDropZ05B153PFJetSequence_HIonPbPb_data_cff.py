...
akSoftDropZ05B153PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akSoftDropZ05B153PFJets"),
...
akSoftDropZ05B153PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akSoftDropZ05B153CaloJets'))

# akSoftDropZ05B153PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak3HiSignalGenJets'))

akSoftDropZ05B153PFbTagger = bTaggers(
    "akSoftDropZ05B153PF",
    0.3)
...
akSoftDropZ05B153PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akSoftDropZ05B153PFJetBtaggingIP = cms.Sequence(
    akSoftDropZ05B153PFImpactParameterTagInfos *
...
akSoftDropZ05B153PFJetBtaggingSV = cms.Sequence(
    akSoftDropZ05B153PFImpactParameterTagInfos *
...
akSoftDropZ05B153PFJetBtaggingNegSV = cms.Sequence(
    akSoftDropZ05B153PFImpactParameterTagInfos *
...
akSoftDropZ05B153PFJetBtaggingMu = cms.Sequence(
    akSoftDropZ05B153PFSoftPFMuonsTagInfos *
    akSoftDropZ05B153PFSoftPFMuonBJetTags +
...
akSoftDropZ05B153PFJetBtagging = cms.Sequence(
    akSoftDropZ05B153PFJetBtaggingIP
    * akSoftDropZ05B153PFJetBtaggingSV
    * akSoftDropZ05B153PFJetBtaggingNegSV
    # * akSoftDropZ05B153PFJetBtaggingMu
    )

akSoftDropZ05B153PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akSoftDropZ05B153PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akSoftDropZ05B153PFSimpleSecondaryVertexHighEffBJetTags"),
...
akSoftDropZ05B153PFpatJetsWithBtagging.userData.userFloats.src += [
    'akSoftDropZ05B153PFNjettiness:tau1',
    'akSoftDropZ05B153PFNjettiness:tau2',
    'akSoftDropZ05B153PFNjettiness:tau3']

akSoftDropZ05B153PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akSoftDropZ05B153PFpatJetsWithBtagging"),
...
akSoftDropZ05B153PFJetSequence_data = cms.Sequence(
    akSoftDropZ05B153PFcorr
    *
    # akSoftDropZ05B153PFJetID
    # *
...
akSoftDropZ05B153PFJetSequence_mb = cms.Sequence(
    akSoftDropZ05B153PFJetSequence_mc)
akSoftDropZ05B153PFJetSequence_jec = cms.Sequence(
    akSoftDropZ05B153PFJetSequence_mc)

akSoftDropZ05B153PFJetSequence = cms.Sequence(
    akSoftDropZ05B153PFJetSequence_data)
