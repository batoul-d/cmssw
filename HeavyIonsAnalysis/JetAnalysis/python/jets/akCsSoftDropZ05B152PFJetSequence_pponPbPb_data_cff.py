...
akCsSoftDropZ05B152PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCsSoftDropZ05B152PFJets"),
...
akCsSoftDropZ05B152PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCsSoftDropZ05B152CaloJets'))

# akCsSoftDropZ05B152PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak2HiSignalGenJets'))

akCsSoftDropZ05B152PFbTagger = bTaggers(
    "akCsSoftDropZ05B152PF",
    0.2)
...
akCsSoftDropZ05B152PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCsSoftDropZ05B152PFJetBtaggingIP = cms.Sequence(
    akCsSoftDropZ05B152PFImpactParameterTagInfos *
...
akCsSoftDropZ05B152PFJetBtaggingSV = cms.Sequence(
    akCsSoftDropZ05B152PFImpactParameterTagInfos *
...
akCsSoftDropZ05B152PFJetBtaggingNegSV = cms.Sequence(
    akCsSoftDropZ05B152PFImpactParameterTagInfos *
...
akCsSoftDropZ05B152PFJetBtaggingMu = cms.Sequence(
    akCsSoftDropZ05B152PFSoftPFMuonsTagInfos *
    akCsSoftDropZ05B152PFSoftPFMuonBJetTags +
...
akCsSoftDropZ05B152PFJetBtagging = cms.Sequence(
    akCsSoftDropZ05B152PFJetBtaggingIP
    * akCsSoftDropZ05B152PFJetBtaggingSV
    * akCsSoftDropZ05B152PFJetBtaggingNegSV
    # * akCsSoftDropZ05B152PFJetBtaggingMu
    )

akCsSoftDropZ05B152PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCsSoftDropZ05B152PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCsSoftDropZ05B152PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCsSoftDropZ05B152PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCsSoftDropZ05B152PFNjettiness:tau1',
    'akCsSoftDropZ05B152PFNjettiness:tau2',
    'akCsSoftDropZ05B152PFNjettiness:tau3']

akCsSoftDropZ05B152PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akCsSoftDropZ05B152PFpatJetsWithBtagging"),
...
akCsSoftDropZ05B152PFJetSequence_data = cms.Sequence(
    akCsSoftDropZ05B152PFcorr
    *
    # akCsSoftDropZ05B152PFJetID
    # *
...
akCsSoftDropZ05B152PFJetSequence_mb = cms.Sequence(
    akCsSoftDropZ05B152PFJetSequence_mc)
akCsSoftDropZ05B152PFJetSequence_jec = cms.Sequence(
    akCsSoftDropZ05B152PFJetSequence_mc)

akCsSoftDropZ05B152PFJetSequence = cms.Sequence(
    akCsSoftDropZ05B152PFJetSequence_data)
