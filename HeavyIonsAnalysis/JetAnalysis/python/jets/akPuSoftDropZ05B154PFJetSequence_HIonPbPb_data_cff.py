...
akPuSoftDropZ05B154PFbTagger = bTaggers(
    "akPuSoftDropZ05B154PF",
    0.4)
...
akPuSoftDropZ05B154PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPuSoftDropZ05B154PFJetBtaggingIP = cms.Sequence(
    akPuSoftDropZ05B154PFImpactParameterTagInfos *
...
akPuSoftDropZ05B154PFJetBtaggingSV = cms.Sequence(
    akPuSoftDropZ05B154PFImpactParameterTagInfos *
...
akPuSoftDropZ05B154PFJetBtaggingNegSV = cms.Sequence(
    akPuSoftDropZ05B154PFImpactParameterTagInfos *
...
akPuSoftDropZ05B154PFJetBtaggingMu = cms.Sequence(
    akPuSoftDropZ05B154PFSoftPFMuonsTagInfos *
    akPuSoftDropZ05B154PFSoftPFMuonBJetTags +
...
akPuSoftDropZ05B154PFJetBtagging = cms.Sequence(
    akPuSoftDropZ05B154PFJetBtaggingIP
    * akPuSoftDropZ05B154PFJetBtaggingSV
    * akPuSoftDropZ05B154PFJetBtaggingNegSV
    # * akPuSoftDropZ05B154PFJetBtaggingMu
    )

akPuSoftDropZ05B154PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akPuSoftDropZ05B154PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPuSoftDropZ05B154PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPuSoftDropZ05B154PFJetSequence_data = cms.Sequence(
    akPuSoftDropZ05B154PFcorr
    *
    # akPuSoftDropZ05B154PFJetID
    # *
...
akPuSoftDropZ05B154PFJetSequence_mb = cms.Sequence(
    akPuSoftDropZ05B154PFJetSequence_mc)
akPuSoftDropZ05B154PFJetSequence_jec = cms.Sequence(
    akPuSoftDropZ05B154PFJetSequence_mc)

akPuSoftDropZ05B154PFJetSequence = cms.Sequence(
    akPuSoftDropZ05B154PFJetSequence_data)
