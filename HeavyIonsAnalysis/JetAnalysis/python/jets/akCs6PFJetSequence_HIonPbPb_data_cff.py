...
akCs6PFparton = patJetPartonMatch.clone(
    src = cms.InputTag("akCs6PFJets"),
...
akCs6PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akCs6CaloJets'))

# akCs6PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak6HiSignalGenJets'))

akCs6PFbTagger = bTaggers(
    "akCs6PF",
    0.6)
...
akCs6PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akCs6PFJetBtaggingIP = cms.Sequence(
    akCs6PFImpactParameterTagInfos *
...
akCs6PFJetBtaggingSV = cms.Sequence(
    akCs6PFImpactParameterTagInfos *
...
akCs6PFJetBtaggingNegSV = cms.Sequence(
    akCs6PFImpactParameterTagInfos *
...
akCs6PFJetBtaggingMu = cms.Sequence(
    akCs6PFSoftPFMuonsTagInfos *
    akCs6PFSoftPFMuonBJetTags +
...
akCs6PFJetBtagging = cms.Sequence(
    akCs6PFJetBtaggingIP
    * akCs6PFJetBtaggingSV
    * akCs6PFJetBtaggingNegSV
    # * akCs6PFJetBtaggingMu
    )

akCs6PFpatJetsWithBtagging = patJets.clone(
    jetSource = cms.InputTag("akCs6PFJets"),
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akCs6PFSimpleSecondaryVertexHighEffBJetTags"),
...
akCs6PFpatJetsWithBtagging.userData.userFloats.src += [
    'akCs6PFNjettiness:tau1',
    'akCs6PFNjettiness:tau2',
    'akCs6PFNjettiness:tau3']

akCs6PFJetAnalyzer = inclusiveJetAnalyzer.clone(
    jetTag = cms.InputTag("akCs6PFpatJetsWithBtagging"),
...
akCs6PFJetSequence_data = cms.Sequence(
    akCs6PFcorr
    *
    # akCs6PFJetID
    # *
...
akCs6PFJetSequence_mb = cms.Sequence(
    akCs6PFJetSequence_mc)
akCs6PFJetSequence_jec = cms.Sequence(
    akCs6PFJetSequence_mc)

akCs6PFJetSequence = cms.Sequence(
    akCs6PFJetSequence_data)
