...
akPu5PFJetID = cms.EDProducer(
    'JetIDProducer',
    JetIDParams,
    src = cms.InputTag('akPu5CaloJets'))

# akPu5PFclean = heavyIonCleanedGenJets.clone(
#     src = cms.InputTag('ak5HiSignalGenJets'))

akPu5PFbTagger = bTaggers(
    "akPu5PF",
    0.5)
...
akPu5PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akPu5PFJetBtaggingIP = cms.Sequence(
    akPu5PFImpactParameterTagInfos *
...
akPu5PFJetBtaggingSV = cms.Sequence(
    akPu5PFImpactParameterTagInfos *
...
akPu5PFJetBtaggingNegSV = cms.Sequence(
    akPu5PFImpactParameterTagInfos *
...
akPu5PFJetBtaggingMu = cms.Sequence(
    akPu5PFSoftPFMuonsTagInfos *
    akPu5PFSoftPFMuonBJetTags +
...
akPu5PFJetBtagging = cms.Sequence(
    akPu5PFJetBtaggingIP
    * akPu5PFJetBtaggingSV
    * akPu5PFJetBtaggingNegSV
    # * akPu5PFJetBtaggingMu
    )

akPu5PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        cms.InputTag("akPu5PFSimpleSecondaryVertexHighEffBJetTags"),
...
akPu5PFpatJetsWithBtagging.userData.userFloats.src += [
    'akPu5PFNjettiness:tau1',
    'akPu5PFNjettiness:tau2',
    'akPu5PFNjettiness:tau3']
...
akPu5PFJetSequence_data = cms.Sequence(
    akPu5PFcorr
    *
    # akPu5PFJetID
    # *
...
akPu5PFJetSequence_mb = cms.Sequence(
    akPu5PFJetSequence_mc)
akPu5PFJetSequence_jec = cms.Sequence(
    akPu5PFJetSequence_mc)

akPu5PFJetSequence = cms.Sequence(
    akPu5PFJetSequence_data)
