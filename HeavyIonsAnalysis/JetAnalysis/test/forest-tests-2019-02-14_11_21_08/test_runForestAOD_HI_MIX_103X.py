...
fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/b/bdiab/public/jpsiJets2019/CMSSW_10_3_1/src/HeavyIonsAnalysis/JetAnalysis/test/forest-tests-2019-02-14_11_21_08/samples/step2_PbPb_1030pre6_HIRECO.root'),
    )
...
process.TFileService = cms.Service("TFileService",
    fileName = cms.string("runForestAOD_HI_MIX_103X.root"))
...
#############################
# jet reco sequence
process.load('HeavyIonsAnalysis.JetAnalysis.fullJetSequence_HI_MIX_cff')
